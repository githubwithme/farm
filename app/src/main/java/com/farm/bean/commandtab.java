...
public class commandtab implements Parcelable
{
	public String Id;
	public String uId;
	...
	public static final Parcelable.Creator<commandtab> CREATOR = new Creator()
	{
		@Override
		public commandtab createFromParcel(Parcel source)
		{
			// 必须按成员变量声明的顺序读取数据，不然会出现获取数据出错
			commandtab p = new commandtab();
		...
		@Override
		public commandtab[] newArray(int size)
		{
			return new commandtab[size];
		}
	};
