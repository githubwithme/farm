...
/**
 *
 * Description: parkweatherfuturetab 实体类</p>
 *
 ...
 * @version 1.0 
 */
@Table(name="parkweatherfuturetab")
public class parkweatherfuturetab implements Parcelable 
{
	public String id;
	public String uId;
   ...
   public static final Parcelable.Creator<parkweatherfuturetab> CREATOR = new Creator()
   {  
      @Override  
      public parkweatherfuturetab createFromParcel(Parcel source)
      {  
         // 必须按成员变量声明的顺序读取数据，不然会出现获取数据出错  
    	 parkweatherfuturetab p = new parkweatherfuturetab();
      ...
      @Override  
      public parkweatherfuturetab[] newArray(int size) 
      {  
          return new parkweatherfuturetab[size];  
      }  
   }; 
