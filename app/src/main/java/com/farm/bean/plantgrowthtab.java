...
public class plantgrowthtab implements Parcelable
{
	public String Id;
	public String uId;
	...
	public static final Parcelable.Creator<plantgrowthtab> CREATOR = new Creator()
	{
		@Override
		public plantgrowthtab createFromParcel(Parcel source)
		{
			// 必须按成员变量声明的顺序读取数据，不然会出现获取数据出错
			plantgrowthtab p = new plantgrowthtab();
		...
		@Override
		public plantgrowthtab[] newArray(int size)
		{
			return new plantgrowthtab[size];
		}
	};
