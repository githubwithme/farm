...
//        sets.add(d2);
    ...
    {
        commembertab commembertab = AppContext.getUserInfo(FinanceAnalysis.this);
        ...
        http.send(HttpRequest.HttpMethod.POST, AppConfig.testurl, params, new RequestCallBack<String>()
        {
            ...
            public void onSuccess(ResponseInfo<String> responseInfo)
            {
                ...
                {
                    AppContext.makeToast(FinanceAnalysis.this, "error_connectDataBase");
                    return;
                }
            ...
            {
                AppContext.makeToast(FinanceAnalysis.this, "error_connectServer");
            }
        });
    }
