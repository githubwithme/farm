...
@EFragment
public class PG_TodayPlant extends Fragment
{
	...
	{
		View rootView = inflater.inflate(R.layout.pg_todayplant, container, false);
	...
	{
		listAdapter = new PG_TodayPlantAdapter(getActivity(), listData);
