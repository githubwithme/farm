...
public class CZ_SelectProduct extends Activity implements CustomHorizontalScrollView_Allitem.CustomOntouch
{
    ...
    {
        Intent intent = new Intent(CZ_SelectProduct.this, NCZ_CreateNewOrder_.class);
    ...
    {
        listData = FileHelper.getAssetsData(CZ_SelectProduct.this, "getAllContractSaleData", contractTab.class);
        if (listData != null)
        {
    ...
    private void initViews()
    {
        ...
        {
            View view = inflater.inflate(R.layout.czselectproduct_titleitem, null);
...
//                    NCZ_SelectProduct.this.startActivity(intent);
        ...
        for (int i = 0; i < listData.get(0).getBatchTimeList().size(); i++)
        {
            View view = inflater.inflate(R.layout.czselectproduct_totalitem, null);
    ...
    class ScrollAdapter extends BaseAdapter
    {
        ...
        {
            convertView = LayoutInflater.from(CZ_SelectProduct.this).inflate(R.layout.czselectproduct_scrolladapter_item, null);
            ...
            {
                View view = LayoutInflater.from(CZ_SelectProduct.this).inflate(R.layout.czselectproduct_dataitem, null);
...
//            addHViews((CustomHorizontalScrollView_Allitem) convertView.findViewById(R.id.item_chscroll_scroll));
    ...
    public class Adapter_Park extends BaseAdapter
    {
        ...
        public Adapter_Park()
        {
            this.listContainer = LayoutInflater.from(CZ_SelectProduct.this);
        }
