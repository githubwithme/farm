...
@EFragment
public class GK_Fragment extends Fragment implements TencentLocationListener, View.OnClickListener
{
    List<ZS> list_zs;
...
//        animateToLocation();
    ...
    {
        View rootView = inflater.inflate(R.layout.gk_fragment, container, false);
