...
import com.farm.adapter.SelectorSecondItemAdapter_Support;
...
@SuppressLint("NewApi")
@EFragment
public class SelectorFragment_Support extends Fragment implements OnClickListener
{
    String strWhere = "";
    String orderby = "";
    ...
    SelectorSecondItemAdapter_Support moreAdapter;
    ...
    public void addTextiew(TextView textView)
    {
        if (!hs_selected.isShown())
        {
            ...
            popupWindow_selector.showAsDropDown(hs_selected, 0, 0);
            popupWindow_selector.update(hs_selected, LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        }
    ...
    {
        moreAdapter = new SelectorSecondItemAdapter_Support(this, getActivity(), BELONG, fitstItemId, firstItemName, secondItemid, secondItemName, list_state);
    ...
    private void initState()
    {
        ...
        for (int i = 0; i < list_SelectRecords.size(); i++)
        {
            ...
            LayoutParams p = new LayoutParams(140, LayoutParams.MATCH_PARENT);
    ...
    public void hidehs_selected()
    {
        ...
        popupWindow_selector.showAsDropDown(rl_recent, 0, 0);
        popupWindow_selector.update(rl_recent, LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
    }
