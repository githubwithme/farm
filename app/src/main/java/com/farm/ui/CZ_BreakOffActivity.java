...
//    dialog.loadingTip(getText(R.string.error_network).toString());
    ...
    void tv_starttime()
    {
        MyDatepicker myDatepicker = new MyDatepicker(CZ_BreakOffActivity.this, tv_starttime);
    ...
    void startdl()
    {
        ...
        myDialog = new MyDialog(CZ_BreakOffActivity.this, R.style.MyDialog, dialog_layout, "断蕾", "是否选择" + tv_starttime.getText().toString() + "这个时间为开始断蕾时间？", "确认", "取消", new MyDialog.CustomDialogListener()
        {
            @Override
...
//        startActivity(intent);
    ...
    public void AddFirstBatchTime()
    {
        ...
        params.addQueryStringParameter("parkid", commembertab.getparkId());
        params.addQueryStringParameter("year", utils.getYear());
        params.addQueryStringParameter("startday", tv_starttime.getText().toString());
