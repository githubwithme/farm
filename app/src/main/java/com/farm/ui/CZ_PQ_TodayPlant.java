...
import com.farm.R;
import com.farm.adapter.CZ_PQ_TodayPlantAdapter;
...
@EActivity(R.layout.cz_pg_todayplant)
public class CZ_PQ_TodayPlant extends Activity
{
	TimeThread timethread;
	SelectorFragment selectorUi;
	Fragment mContent = new Fragment();
	private CZ_PQ_TodayPlantAdapter listAdapter;
	...
	void btn_add()
	{
		Intent intent = new Intent(CZ_PQ_TodayPlant.this, AddPlant_.class);
	...
	void afterOncreate()
	{
		...
		dictionary = DictionaryHelper.getDictionaryFromAssess(CZ_PQ_TodayPlant.this, "PG_MQ");
...
/*	BroadcastReceiver receiver_update = new BroadcastReceiver()// 从扩展页面返回信息
	...
	private void getListData(final int actiontype, final int objtype, final PullToRefreshListView lv, final BaseAdapter adapter, final TextView more, final ProgressBar progressBar, final int PAGESIZE, int PAGEINDEX)
	{
		...
		http.send(HttpRequest.HttpMethod.POST, AppConfig.testurl, params, new RequestCallBack<String>()
		{
			...
			public void onSuccess(ResponseInfo<String> responseInfo)
			{
				...
				{
					AppContext.makeToast(CZ_PQ_TodayPlant.this, "error_connectDataBase");
					return;
				}
				// 数据处理
				...
				case UIHelper.LISTVIEW_ACTION_CHANGE_CATALOG:// 页面切换
					...
					if (actiontype == UIHelper.LISTVIEW_ACTION_REFRESH)
					{
						...
						if (newdata > 0)
						{
							NewDataToast.makeText(CZ_PQ_TodayPlant.this, getString(R.string.new_data_toast_message, newdata), appContext.isAppSound(), R.raw.newdatatoast).show();
						} else
						{
							// NewDataToast.makeText(CZ_PG_TodayPlant.this,
				...
				} else if (size == -1)
				{
					...
					AppContext.makeToast(CZ_PQ_TodayPlant.this, "load_error");
				}
			...
			{
				AppContext.makeToast(CZ_PQ_TodayPlant.this, "error_connectServer");
			}
		});
	}
	...
	{
		listAdapter = new CZ_PQ_TodayPlantAdapter(CZ_PQ_TodayPlant.this, listData);
		list_footer = CZ_PQ_TodayPlant.this.getLayoutInflater().inflate(R.layout.listview_footer, null);
