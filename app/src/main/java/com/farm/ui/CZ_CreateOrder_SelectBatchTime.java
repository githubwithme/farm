...
public class CZ_CreateOrder_SelectBatchTime extends Activity
{
...
//        deleNewSaleAddsalefor();
    ...
    {
        listNewData = FileHelper.getAssetsData(CZ_CreateOrder_SelectBatchTime.this, "getBatchTimeByUid", parktab.class);
        selectBatchTime_adapter = new SelectBatchTime_Adapter(CZ_CreateOrder_SelectBatchTime.this, listNewData, expandableListView);
...
//    }
    ...
    {
        commembertab commembertab = AppContext.getUserInfo(CZ_CreateOrder_SelectBatchTime.this);
            ...
            public void onSuccess(ResponseInfo<String> responseInfo)
            {
                ...
                if (result.getResultCode() == 1)// -1出错；0结果集数量为0；结果列表
                {
                    if (result.getAffectedRows() != 0)
                    {
                        ...
                        selectBatchTime_adapter = new SelectBatchTime_Adapter(CZ_CreateOrder_SelectBatchTime.this, list, expandableListView);
                        expandableListView.setAdapter(selectBatchTime_adapter);
                        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener()
                        {
                            ...
                            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id)
                            {
                                ...
                                Intent intent = new Intent(CZ_CreateOrder_SelectBatchTime.this, NCZ_CreateOrder_SelectProduct_.class);
                                ...
                                CZ_CreateOrder_SelectBatchTime.this.startActivity(intent);
                                return true;
                            }
                        });
                        utils.setListViewHeight(expandableListView);
...
//                        }
                ...
                {
                    AppContext.makeToast(CZ_CreateOrder_SelectBatchTime.this, "error_connectDataBase");
                    return;
                }
            ...
            {
                AppContext.makeToast(CZ_CreateOrder_SelectBatchTime.this, "error_connectServer");
            }
        });
    }
