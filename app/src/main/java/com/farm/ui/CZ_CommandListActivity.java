...
public class CZ_CommandListActivity extends Activity
{
    com.farm.bean.commembertab commembertab;
    Fragment mContent = new Fragment();
    CZ_Commanding cz_commanding;
    CZ_Commanded cz_commanded;
...
//    NCZ_Commanded ncz_commanded;
    ...
    {
        setBackground(0);
        switchContent(mContent, cz_commanding);
    }
    ...
    {
        setBackground(1);
        switchContent(mContent, cz_commanded);
    }

    @AfterViews
    void afterOncreate()
    {
        cz_commanding =new CZ_Commanding_();
        cz_commanded=new CZ_Commanded_();
