...
import com.farm.R;
import com.farm.adapter.CZ_ToDayPQdapter;
...
public class CZ_ToDayPQ extends Activity
{
        ...
        http.send(HttpRequest.HttpMethod.POST, AppConfig.testurl, params, new RequestCallBack<String>()
        {
            ...
            public void onSuccess(ResponseInfo<String> responseInfo)
            {
                ...
                switch (actiontype)
                {
                    ...
                    case UIHelper.LISTVIEW_ACTION_CHANGE_CATALOG:// 页面切换
                        ...
                        if (actiontype == UIHelper.LISTVIEW_ACTION_REFRESH)
                        {
                            ...
                            if (newdata > 0)
                            {
                                NewDataToast.makeText(CZ_ToDayPQ.this, getString(R.string.new_data_toast_message, newdata), appContext.isAppSound(), R.raw.newdatatoast).show();
                            } else
                            {
                            }
                        }
                ...
                } else if (size == -1)
                {
                    ...
                    AppContext.makeToast(CZ_ToDayPQ.this, "load_error");
                }
    ...
    {
        listAdapter = new CZ_ToDayPQdapter(CZ_ToDayPQ.this, listData);
        list_footer = CZ_ToDayPQ.this.getLayoutInflater().inflate(R.layout.listview_footer, null);
