	...
	class FoundationFragment extends Fragment
	{
		...
		public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
		{
			...
			} else
			{
				...
				if (!planttab.getcDate().equals(""))
				{
					tv_cDate.setText(planttab.getcDate().substring(5, 10));
				}
				if (!planttab.getzDate().equals(""))
				{
					tv_zDate.setText(planttab.getzDate().substring(5, 10));
				}
