 ...
 * @description :
 */
@EActivity(R.layout.ncz_growthtreeactivity)
public class NCZ_GrowthTreeActivity extends Activity
{
    String gcdid;
    ...
    void afterOncreate()
    {
        lv_tree.setAdapter(new TreeAdapter(NCZ_GrowthTreeActivity.this, listNewData));
...
//                        listNewData = JSON.parseArray(JSON.parseObject(jsonObject.getString("gcjllist"), Result.class).getRows().toJSONString(), PlantGcjl.class);
                        ...
                        treeAdapter = new TreeAdapter(NCZ_GrowthTreeActivity.this, listNewData);
                ...
                {
                    AppContext.makeToast(NCZ_GrowthTreeActivity.this, "error_connectDataBase");
                    return;
                }
            }
            ...
            {
                AppContext.makeToast(NCZ_GrowthTreeActivity.this, "exception_network");
            }
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (lmap.get(position) == null)
            {
                ...
                listItemView.ll_left.setOnClickListener(new OnClickListener()
                {
                    ...
                    {
                        int pos = v.getId();
                        Intent intent = new Intent(NCZ_GrowthTreeActivity.this, ObservationRecordActivity_.class);
                        intent.putExtra("gcid", listItems.get(pos).getId());
                        NCZ_GrowthTreeActivity.this.startActivity(intent);
                    }
                });
