...
@SuppressLint("NewApi")
@EFragment
public class Fragment_SmallSales extends Fragment implements OnClickListener
{
	...
	void afterOncreate()
	{
		dictionary = DictionaryHelper.getDictionaryFromAssess(getActivity(), "XS");
	...
	{
		listAdapter = new ListViewSaleAdapter(getActivity(), listData);
		...
		frame_listview_news.setOnItemClickListener(new OnItemClickListener()
		{
