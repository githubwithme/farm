...
import com.farm.R;
import com.farm.adapter.ListViewSingleGoodInvoicingAdapter;
...
@EActivity(R.layout.singlegoodnvoicinglist)
public class SingleGoodInvoicingList extends Activity implements OnClickListener
{
	SelectorFragment selectorUi;
	Fragment mContent = new Fragment();
	private ListViewSingleGoodInvoicingAdapter listAdapter;
	...
	void afterOncreate()
	{
		dictionary = DictionaryHelper.getDictionaryFromAssess(SingleGoodInvoicingList.this, "DGJXC");
	...
	{
		commembertab commembertab = AppContext.getUserInfo(SingleGoodInvoicingList.this);
		...
		http.send(HttpRequest.HttpMethod.POST, AppConfig.testurl, params, new RequestCallBack<String>()
		{
			...
			public void onSuccess(ResponseInfo<String> responseInfo)
			{
				...
				{
					AppContext.makeToast(SingleGoodInvoicingList.this, "error_connectDataBase");
					return;
				}
				// 数据处理
				...
				case UIHelper.LISTVIEW_ACTION_CHANGE_CATALOG:// 页面切换
					...
					if (actiontype == UIHelper.LISTVIEW_ACTION_REFRESH)
					{
						...
						if (newdata > 0)
						{
							NewDataToast.makeText(SingleGoodInvoicingList.this, getString(R.string.new_data_toast_message, newdata), appContext.isAppSound(), R.raw.newdatatoast).show();
						} else
						{
							// NewDataToast.makeText(SingleGoodInvoicingList.this,
				...
				} else if (size == -1)
				{
					...
					AppContext.makeToast(SingleGoodInvoicingList.this, "load_error");
				}
			...
			{
				AppContext.makeToast(SingleGoodInvoicingList.this, "error_connectServer");
			}
		});
	}
	...
	{
		listAdapter = new ListViewSingleGoodInvoicingAdapter(SingleGoodInvoicingList.this, listData);
		list_footer = SingleGoodInvoicingList.this.getLayoutInflater().inflate(R.layout.listview_footer, null);
		...
		frame_listview_news.setOnItemClickListener(new AdapterView.OnItemClickListener()
		{
			public void onItemClick(AdapterView<?> parent, View view, int position, long id)
			{
				...
				// {
				// Intent intent = new Intent(SingleGoodInvoicingList.this,
				// SpecialCostDetail_.class);
				// intent.putExtra("plant", planttab);//
				// startActivity(intent);
				// }
			}
		});
