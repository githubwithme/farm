...
public class NCZ_PQ_TodayCommand extends Activity implements OnClickListener
{
	...
	void afterOncreate()
	{
		dictionary = DictionaryHelper.getDictionaryFromAssess(NCZ_PQ_TodayCommand.this, "NCZ_CMD");
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		getActionBar().hide();
		appContext = (AppContext) NCZ_PQ_TodayCommand.this.getApplication();
		IntentFilter intentfilter_update = new IntentFilter(AppContext.BROADCAST_UPDATEPLANT);
		NCZ_PQ_TodayCommand.this.registerReceiver(receiver_update, intentfilter_update);
	...
	{
		String strWher = DictionaryHelper.getStrWhere_ncz_cmd(NCZ_PQ_TodayCommand.this, dictionary);
			...
			public void onSuccess(ResponseInfo<String> responseInfo)
			{
				...
				case UIHelper.LISTVIEW_ACTION_CHANGE_CATALOG:// 页面切换
					...
					if (actiontype == UIHelper.LISTVIEW_ACTION_REFRESH)
					{
						...
						if (newdata > 0)
						{
							NewDataToast.makeText(NCZ_PQ_TodayCommand.this, getString(R.string.new_data_toast_message, newdata), appContext.isAppSound(), R.raw.newdatatoast).show();
						} else
						{
				...
				} else if (size == -1)
				{
					...
					AppContext.makeToast(NCZ_PQ_TodayCommand.this, "load_error");
				}
	...
	{
		listAdapter = new NCZ_PQ_CommandListAdapter(NCZ_PQ_TodayCommand.this, listData);
		list_footer = NCZ_PQ_TodayCommand.this.getLayoutInflater().inflate(R.layout.listview_footer, null);
		...
		frame_listview_news.setOnItemClickListener(new AdapterView.OnItemClickListener()
		{
			public void onItemClick(AdapterView<?> parent, View view, int position, long id)
			{
				...
				if (commandtab == null)
					return;
				commembertab commembertab = AppContext.getUserInfo(NCZ_PQ_TodayCommand.this);
				AppContext.updateStatus(NCZ_PQ_TodayCommand.this, "0", commandtab.getId(), "1", commembertab.getId());
	...
	public void onClick(View v)
	{
		...
		case R.id.btn_standardprocommand:
			intent = new Intent(NCZ_PQ_TodayCommand.this, AddStandardCommand_.class);
			startActivity(intent);
			break;
		case R.id.btn_nonstandardprocommand:
			intent = new Intent(NCZ_PQ_TodayCommand.this, AddNotStandardCommand_.class);
			startActivity(intent);
			break;
		case R.id.btn_nonprocommand:
			intent = new Intent(NCZ_PQ_TodayCommand.this, AddNotProductCommand_.class);
			startActivity(intent);
			break;
