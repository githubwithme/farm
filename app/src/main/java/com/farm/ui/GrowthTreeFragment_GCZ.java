 ...
 */
@EFragment
public class GrowthTreeFragment_GCZ extends Fragment
{
     ...
     * @return
     */
    public static GrowthTreeFragment_GCZ newInstance(int index)
    {
        Bundle bundle = new Bundle();
        bundle.putInt(FRAGMENT_INDEX, index);
        GrowthTreeFragment_GCZ fragment = new GrowthTreeFragment_GCZ_();
    ...
    {
        View rootView = inflater.inflate(R.layout.growthtreefragment_gcz, container, false);
        planttab = getArguments().getParcelable("bean");
        return rootView;
    }
