...
public class Analysis extends Activity
{
	...
	void afterOncreate()
	{
		if (AppContext.getUserInfo(this).getnlevel().equals("1"))
		{
		 ...
		 switchContent_week(mContent_week, fragment_eventAnalysis);
		 switchContent_history(mContent_history, historyWeatherFragment);
	}
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		fragment_eventAnalysis = new Fragment_EventAnalysis();
		fragment_eventAnalysis.setArguments(bundle);
		historyWeatherFragment = new HistoryWeatherFragment_();
		historyWeatherFragment.setArguments(bundle);
	}
	...
	public void showPop_title()
	{
		...
		listview.setAdapter(new TitleAdapter(Analysis.this, data));
