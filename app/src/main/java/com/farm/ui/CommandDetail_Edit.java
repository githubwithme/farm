 ...
 */
@EActivity(R.layout.commanddetail_edit)
public class CommandDetail_Edit extends FragmentActivity
{
    MyDialog myDialog;
...
Button btn_delete;
    ...
    void afterOncreate()
    {
        ...
        viewPagerAdapter_gcdDetail = new ViewPagerAdapter_GcdDetail(CommandDetail_Edit.this.getSupportFragmentManager(), vPager, fragmentList);
...
//                Toast.makeText(GcdDetail.this, "show", Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        commembertab = AppContext.getUserInfo(CommandDetail_Edit.this);
    ...
    private void showDeleteTip(final String cmdid, final String statusID)
    {
        ...
        myDialog = new MyDialog(CommandDetail_Edit.this, R.style.MyDialog, dialog_layout, "图片", "确定删除吗?", "删除", "取消", new MyDialog.CustomDialogListener()
        {
            @Override
    ...
    {
        com.farm.bean.commembertab commembertab = AppContext.getUserInfo(CommandDetail_Edit.this);
        ...
        http.send(HttpRequest.HttpMethod.POST, AppConfig.testurl, params, new RequestCallBack<String>()
        {
            ...
            public void onSuccess(ResponseInfo<String> responseInfo)
            {
                ...
                if (result.getResultCode() == 1)// -1出错；0结果集数量为0；结果列表
                {
                    ...
                    {
                        Toast.makeText(CommandDetail_Edit.this, "删除成功！", Toast.LENGTH_SHORT).show();
                        myDialog.cancel();
                        finish();
                    } else
                    {
                        Toast.makeText(CommandDetail_Edit.this, "删除失败！", Toast.LENGTH_SHORT).show();
                    }
                } else
                {
                    AppContext.makeToast(CommandDetail_Edit.this, "error_connectDataBase");
                    return;
                }
            ...
            {
                AppContext.makeToast(CommandDetail_Edit.this, "error_connectServer");
            }
        });
    }
}
