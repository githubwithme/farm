...
public class CZ_MQActivity extends Activity
{
...
//                        listNewData = JSON.parseArray(JSON.parseObject(jsonObject.getString("img_url"), Result.class).getRows().toJSONString(), PlantGcd.class);
                ...
                {
                    AppContext.makeToast(CZ_MQActivity.this, "error_connectDataBase");
                    return;
                }
                // 数据处理
...
//                                }
                ...
                } else if (size == -1)
                {
                    ...
                    AppContext.makeToast(CZ_MQActivity.this, "load_error");
                }
...
//                    }
            ...
            {
                AppContext.makeToast(CZ_MQActivity.this, "error_connectServer");
            }
        });
    }
    ...
    {
        listAdapter = new NCZ_PlantGcdListAdapter(CZ_MQActivity.this, listData);
        list_footer = CZ_MQActivity.this.getLayoutInflater().inflate(R.layout.listview_footer, null);
