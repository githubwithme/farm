...
public class ContactsFragment extends Fragment implements OnClickListener
{
    ...
    void afterOncreate()
    {
        ...
        List<planttab> list = FileHelper.getAssetsData(getActivity(), "plantgrowthlist", planttab.class);
        listAdapter = new ListViewDaoGangAdapter(getActivity(), list);
    ...
    {
        View rootView = inflater.inflate(R.layout.daoganglist, container, false);
