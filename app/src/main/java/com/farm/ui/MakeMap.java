...
@EActivity(R.layout.makemap)
public class MakeMap extends Activity implements TencentLocationListener, View.OnClickListener
{
...
//                addMarker_Paint(0, latlng, R.drawable.location_start);
                ...
                line.setColor(MakeMap.this.getResources().getColor(R.color.black));
                line.setWidth(4f);
                Overlays.add(line);
            }
        });
                ...
                public void onMapClick(LatLng latlng)
                {
                    ...
                    if (latlng_clickpostion != null)
                    {
                        for (int i = 0; i < list_polygon.size(); i++)
                        {
                            ...
                            {
                                Toast.makeText(MakeMap.this, "在范围内", Toast.LENGTH_SHORT).show();
                            }
                        }
...
//                        addMarker(prelatLng, R.drawable.location_start);
    ...
    {
        LayoutInflater layoutInflater = (LayoutInflater) MakeMap.this.getSystemService(MakeMap.this.LAYOUT_INFLATER_SERVICE);
...
//        lp.alpha = 0.7f;
//        AddOrderMap.this.getWindow().setAttributes(lp);
        pv_command.findViewById(R.id.btn_standardprocommand).setOnClickListener(MakeMap.this);
        pv_command.findViewById(R.id.btn_nonstandardprocommand).setOnClickListener(MakeMap.this);
        pv_command.findViewById(R.id.btn_nonprocommand).setOnClickListener(MakeMap.this);
    }
...
//        AddOrderMap.this.getWindow().setAttributes(lp);
        ...
        dl_zs_adapter = new DL_ZS_Adapter(MakeMap.this, list_zs);
...
//                }
                ...
                SqliteDb.save(MakeMap.this, zs);
                if (pv_command.isShown())
                {
                    list_zs = SqliteDb.getZS(MakeMap.this, ZS.class, commembertab.getareaId());
    ...
    {
        final View dialog_layout = (LinearLayout) LayoutInflater.from(MakeMap.this).inflate(R.layout.customdialog_addzs, null);
        customdialog_editdlinfor = new CustomDialog_EditDLInfor(MakeMap.this, R.style.MyDialog, dialog_layout);
    ...
    {
        final View dialog_layout = (LinearLayout) LayoutInflater.from(MakeMap.this).inflate(R.layout.customdialog_editpolygoninfo, null);
        customdialog_editpolygoninfor = new CustomDialog_EditPolygonInfo(MakeMap.this, R.style.MyDialog, dialog_layout);
       ListView lv_department = (ListView) dialog_layout.findViewById(R.id.lv_department);
        Button btn_sure = (Button) dialog_layout.findViewById(R.id.btn_sure);
        list_department=getDepartment(MakeMap.this);
        department_adapter = new Department_Adapter(MakeMap.this, list_department);
                    ...
                    for (int i = 0; i < list_parktab.size(); i++)
                    {
                        if (d.getId().equals(list_parktab.get(i).getid()))
                        {
                            for (int m = 0; m < list_select.size(); m++)
                            {
                                ...
                                coordinatesBean.setSaleid("");
                                coordinatesBean.setOrders("");
                                SqliteDb.save(MakeMap.this, coordinatesBean);
//                uploadCoordinatesBean(coordinatesBean);
                            }
...
//                uploadCoordinatesBean(coordinatesBean);
    ...
    {
        final View dialog_layout = (RelativeLayout) LayoutInflater.from(MakeMap.this).inflate(R.layout.customdialog_operatepolygon, null);
        customdialog_operatepolygon = new CustomDialog_OperatePolygon(MakeMap.this, R.style.MyDialog, dialog_layout);
...
//        }
//        getBoundary_farm();
//        SqliteDb.deletetemp(MakeMap.this);

        TencentLocationRequest request = TencentLocationRequest.create();
        TencentLocationManager locationManager = TencentLocationManager.getInstance(MakeMap.this);
        ...
        map = new HashMap<>();
        if (!utils.isOPen(MakeMap.this))
        {
            utils.openGPSSettings(MakeMap.this);
        }
...
//        getTestData("points");
        ...
        String str_farm_boundary_free = SqliteDb.getBoundary_farm_free(MakeMap.this, "60", "farm_boundary_free");
...
//        String str_farm_boundary = SqliteDb.getBoundary_farm_free(MakeMap.this, "60", "farm_boundary");
...
//        }
    ...
    public void onLocationChanged(TencentLocation location, int error, String reason)
    {
        if (TencentLocation.ERROR_OK == error) // 定位成功
        {
            ...
            //全局记录坐标
            AppContext appContext = (AppContext) MakeMap.this.getApplication();
...
//                    Toast.makeText(AddOrderMap.this, "添加成功！", Toast.LENGTH_SHORT).show();
                ...
                {
                    AppContext.makeToast(MakeMap.this, "error_connectDataBase");
                    return;
                }
            }
            ...
            {
                String A = "";
                AppContext.makeToast(MakeMap.this, "error_connectServer");
            }
        });
    }
    ...
    private void getBoundary_farm()
    {
        ...
        http.send(HttpRequest.HttpMethod.POST, AppConfig.testurl, params, new RequestCallBack<String>()
        {
            ...
            {
                Toast.makeText(MakeMap.this, "error_connectServer", Toast.LENGTH_SHORT).show();
            }
        });
    }
                ...
                for (int i = 0; i <list_polygon_all.size() ; i++)
                {
                    ...
                    if (polygon.contains(latlng))
                    {
                       list_CoordinatesBean_currentPolygon= list_polygon_allCoordinatesBean.get(i);
                        ...
                        list_mark = new ArrayList<>();
                        int dd = list_single_polygon.size() / 9;
                        int num = dd;
