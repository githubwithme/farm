 ...
 */
@EActivity(R.layout.add_notstd__cmd_selfnew)
public class AddNotStd_Cmd_Self_new extends FragmentActivity implements FragmentCallBack
{
    ...
    void afterOncreate()
    {
        ...
        SqliteDb.deleteAllSelectCmdArea(AddNotStd_Cmd_Self_new.this, SelectCmdArea.class);
        SqliteDb.deleteAllSelectCmdArea(AddNotStd_Cmd_Self_new.this, goodslisttab.class);
...
//        addStd_cmd_stepFive = new AddStd_Cmd_StepFive_();
        ...
        adapter = new ViewPagerAdapter_AddNotStd_Cmd_Self(AddNotStd_Cmd_Self_new.this.getSupportFragmentManager(), vPager, fragmentList);
...
//        switchFragment();//通过回调方式切换
    ...
    private void showExistTip()
    {
        ...
        myDialog = new MyDialog(AddNotStd_Cmd_Self_new.this, R.style.MyDialog, dialog_layout, "取消标准生产指令", "确定取消吗？", "是", "否", new MyDialog.CustomDialogListener()
        {
            @Override
