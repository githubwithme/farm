 ...
 */
@EFragment
public class AddStd_Cmd_Self_StepTwo extends Fragment
{
    ...
    {
        View rootView = inflater.inflate(R.layout.add_std__cmd__step_two_self, container, false);
                ...
                if (result.getResultCode() == 1)
                {
                    if (result.getAffectedRows() != 0)
                    {
                        ...
                        if (lsitNewData != null)
                        {
                            ...
                            addStd_cmd_stepTwo_self_adapter = new AddStd_cmd_StepTwo_self_Adapter(getActivity(), dictionary_wheel, mainlistview, list_goods, tv_head, fragmentCallBack);
                            mainlistview.setAdapter(addStd_cmd_stepTwo_self_adapter);
