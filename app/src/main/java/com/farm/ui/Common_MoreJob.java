...
@SuppressLint("NewApi")
@EActivity(R.layout.pg_joblist)
public class Common_MoreJob extends Activity
{
	...
	{
		String strWher = DictionaryHelper.getStrWhere_morejob(Common_MoreJob.this, dictionary.getBELONG());
		...
		http.send(HttpRequest.HttpMethod.POST, AppConfig.testurl, params, new RequestCallBack<String>()
		{
			...
			public void onSuccess(ResponseInfo<String> responseInfo)
			{
				...
				{
					AppContext.makeToast(Common_MoreJob.this, "error_connectDataBase");
					return;
				}
				// 数据处理
				...
				case UIHelper.LISTVIEW_ACTION_CHANGE_CATALOG:// 页面切换
					...
					if (actiontype == UIHelper.LISTVIEW_ACTION_REFRESH)
					{
						...
						if (newdata > 0)
						{
							NewDataToast.makeText(Common_MoreJob.this, getString(R.string.new_data_toast_message, newdata), appContext.isAppSound(), R.raw.newdatatoast).show();
						} else
						{
				...
				} else if (size == -1)
				{
					...
					AppContext.makeToast(Common_MoreJob.this, "load_error");
				}
			...
			{
				AppContext.makeToast(Common_MoreJob.this, "error_connectServer");
			}
		});
	}
	...
	{
		listAdapter = new Common_TodayJobAdapter(Common_MoreJob.this, listData);
		list_footer = Common_MoreJob.this.getLayoutInflater().inflate(R.layout.listview_footer, null);
		...
		frame_listview_news.setOnItemClickListener(new AdapterView.OnItemClickListener()
		{
			public void onItemClick(AdapterView<?> parent, View view, int position, long id)
			{
				...
				if (jobtab == null)
					return;
				commembertab commembertab = AppContext.getUserInfo(Common_MoreJob.this);
				AppContext.updateStatus(Common_MoreJob.this, "0", jobtab.getId(), "1", commembertab.getId());
