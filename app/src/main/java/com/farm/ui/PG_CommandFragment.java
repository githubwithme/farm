...
@EFragment
public class PG_CommandFragment extends Fragment implements OnClickListener
{
...
//        switchContent(mContent, selectorUi);
    ...
    {
        View rootView = inflater.inflate(R.layout.pg_commandfragment, container, false);
...
//        joblist = getArguments().getParcelableArrayList("jobtablist");
    ...
    class ListViewPGCommandAdapter extends BaseAdapter
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            {
                // 获取list_item布局文件的视图
                convertView = listContainer.inflate(R.layout.adapter_pgcommand, null);
                listItemView = new ListItemView();
                // 获取控件对象
