...
public class PG_SP_EditOreder extends Activity
{
    ...
    void btn_addcg()
    {
        Intent intent = new Intent(PG_SP_EditOreder.this, Add_workPeopel_.class);
...
//        sellOrder.setSaletime(utils.getTime());
        ...
        sellOrders.setProducer(sellOrder.getProducer());
        ...
        http.send(HttpRequest.HttpMethod.POST, AppConfig.testurl, params, new RequestCallBack<String>()
        {
            ...
            public void onSuccess(ResponseInfo<String> responseInfo)
            {
                ...
                if (result.getResultCode() == 1)// -1出错；0结果集数量为0；结果列表
                {
                    ...
                    {
                        Toast.makeText(PG_SP_EditOreder.this, "订单修改成功！", Toast.LENGTH_SHORT).show();
                ...
                {
                    AppContext.makeToast(PG_SP_EditOreder.this, "error_connectDataBase");
                    return;
                }
            ...
            {
                AppContext.makeToast(PG_SP_EditOreder.this, "error_connectServer");
            }
        });
    }
  /*  @Click
    ...
    void afterOncreate()
    {
        ...
        adapter_editSellOrderDetail_ncz = new Adapter_EditSellOrderDetail_NCZ(PG_SP_EditOreder.this);
...
//        broadcast = getIntent().getStringExtra("broadcast");
    ...
    void dd_time()
    {
        MyDatepicker myDatepicker = new MyDatepicker(PG_SP_EditOreder.this, dd_time);
        ...
        http.send(HttpRequest.HttpMethod.POST, AppConfig.testurl, params, new RequestCallBack<String>()
        {
            ...
            public void onSuccess(ResponseInfo<String> responseInfo)
            {
                ...
                if (result.getResultCode() == 1)// -1出错；0结果集数量为0；结果列表
                {
                    if (result.getAffectedRows() != 0)
                    {
                        Toast.makeText(PG_SP_EditOreder.this, "订单创建成功！", Toast.LENGTH_SHORT).show();
                        finish();
                    }
...
*/
                ...
                {
                    Toast.makeText(PG_SP_EditOreder.this, "修改失败！", Toast.LENGTH_SHORT).show();
                }
    ...
    {
        View dialog_layout = (RelativeLayout) PG_SP_EditOreder.this.getLayoutInflater().inflate(R.layout.customdialog_listview, null);
        customDialog_listView = new CustomDialog_ListView(PG_SP_EditOreder.this, R.style.MyDialog, dialog_layout, listdata, listid, new CustomDialog_ListView.CustomDialogListener()
        {
            @Override
