...
public class DaoGangList extends Activity implements OnClickListener
{
	...
	{
		commembertab commembertab = AppContext.getUserInfo(DaoGangList.this);
		...
		http.send(HttpRequest.HttpMethod.POST, AppConfig.testurl, params, new RequestCallBack<String>()
		{
			...
			public void onSuccess(ResponseInfo<String> responseInfo)
			{
				...
				{
					AppContext.makeToast(DaoGangList.this, "error_connectDataBase");
					return;
				}
				// 数据处理
				...
				case UIHelper.LISTVIEW_ACTION_CHANGE_CATALOG:// 页面切换
					...
					if (actiontype == UIHelper.LISTVIEW_ACTION_REFRESH)
					{
						...
						if (newdata > 0)
						{
							NewDataToast.makeText(DaoGangList.this, getString(R.string.new_data_toast_message, newdata), appContext.isAppSound(), R.raw.newdatatoast).show();
						} else
						{
							// NewDataToast.makeText(DaoGangList.this,
				...
				} else if (size == -1)
				{
					...
					AppContext.makeToast(DaoGangList.this, "load_error");
				}
			...
			{
				AppContext.makeToast(DaoGangList.this, "error_connectServer");
			}
		});
	}
	...
	{
		listAdapter = new ListViewDaoGangAdapter(DaoGangList.this, listData);
		list_footer = DaoGangList.this.getLayoutInflater().inflate(R.layout.listview_footer, null);
