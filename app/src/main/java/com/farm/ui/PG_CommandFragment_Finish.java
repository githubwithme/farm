...
@EFragment
public class PG_CommandFragment_Finish extends Fragment implements OnClickListener
{
...
//        switchContent(mContent, selectorUi);
    ...
    {
        View rootView = inflater.inflate(R.layout.pg_commandfragment_finish, container, false);
...
//                Intent intent = new Intent(getActivity(), CommandDetail_Edit_.class);
    ...
    class ListViewPGCommandAdapter extends BaseAdapter
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            {
                // 获取list_item布局文件的视图
                convertView = listContainer.inflate(R.layout.adapter_pgfinishcommand, null);
                listItemView = new ListItemView();
                // 获取控件对象
