    ...
    private void initMarkerClickListener()
    {
        tencentMap.setOnMarkerClickListener(new TencentMap.OnMarkerClickListener()
        {
            ...
            public boolean onMarkerClick(Marker marker)
            {
                ...
                {
                    PolygonBean polygonbean = SqliteDb.getLayerbyuuid(NCZ_SaleMap.this, uuid);
...
//        pw_batch.setAnimationStyle(R.style.topintopout);
        ...
        OrderList_Adapter orderList_adapter = new OrderList_Adapter(NCZ_SaleMap.this, list_BatchOfProduct);
