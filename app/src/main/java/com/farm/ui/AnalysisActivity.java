...
public class AnalysisActivity extends Activity
{
	...
	void rl_kc()
	{
		Intent intent = new Intent(this, AnalysisGoodActivity_.class);
	...
	void rl_zz()
	{
		Intent intent = new Intent(this, AnalysisProductActivity_.class);
		startActivity(intent);
	}
	...
	void rl_xs()
	{
		Intent intent = new Intent(this, AnalysisSaleActivity_.class);
		startActivity(intent);
	}
