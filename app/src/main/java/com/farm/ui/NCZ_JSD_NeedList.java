...
public class NCZ_JSD_NeedList extends Activity implements CustomHorizontalScrollView_Allitem.CustomOntouch
{
        ...
        http.send(HttpRequest.HttpMethod.POST, AppConfig.testurl, params, new RequestCallBack<String>()
        {
            ...
            public void onSuccess(ResponseInfo<String> responseInfo)
            {
             ...
             /*       } else
                ...
                {
                    AppContext.makeToast(NCZ_JSD_NeedList.this, "error_connectDataBase");
                    return;
                }
            ...
            {
                AppContext.makeToast(NCZ_JSD_NeedList.this, "error_connectServer");
            }
        });
    }
