...
@EFragment
public class Product_Fragment extends Fragment implements TencentLocationListener, View.OnClickListener
{
    List<ZS> list_zs;
...
//        lp.alpha = 0.7f;
//        getActivity().getWindow().setAttributes(lp);
        pv_command.findViewById(R.id.btn_standardprocommand).setOnClickListener(Product_Fragment.this);
        pv_command.findViewById(R.id.btn_nonstandardprocommand).setOnClickListener(Product_Fragment.this);
        pv_command.findViewById(R.id.btn_nonprocommand).setOnClickListener(Product_Fragment.this);
    }
