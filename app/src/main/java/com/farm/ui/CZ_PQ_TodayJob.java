...
import com.farm.R;
import com.farm.adapter.CZ_PQ_TodayJobAdapter;
...
public class CZ_PQ_TodayJob extends Activity
{
			...
			public void onSuccess(ResponseInfo<String> responseInfo)
			{
				...
				case UIHelper.LISTVIEW_ACTION_CHANGE_CATALOG:// 页面切换
					...
					if (actiontype == UIHelper.LISTVIEW_ACTION_REFRESH)
					{
						...
						if (newdata > 0)
						{
							NewDataToast.makeText(CZ_PQ_TodayJob.this, getString(R.string.new_data_toast_message, newdata), appContext.isAppSound(), R.raw.newdatatoast).show();
						} else
						{
				...
				} else if (size == -1)
				{
					...
					AppContext.makeToast(CZ_PQ_TodayJob.this, "load_error");
				}
	...
	{
		listAdapter = new CZ_PQ_TodayJobAdapter(CZ_PQ_TodayJob.this, listData);
		list_footer = CZ_PQ_TodayJob.this.getLayoutInflater().inflate(R.layout.listview_footer, null);
		...
		frame_listview_news.setOnItemClickListener(new AdapterView.OnItemClickListener()
		{
			public void onItemClick(AdapterView<?> parent, View view, int position, long id)
			{
				...
				Intent intent = new Intent(CZ_PQ_TodayJob.this, Common_JobDetail_Assess_.class);
