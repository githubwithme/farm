 ...
 */
@EActivity(R.layout.displaybd)
public class DisplayImageOfLocal extends Activity
{
    ...
    void afterOncreate()
    {
        // /storage/emulated/0/Tencent/tassistant/cloudkit/html/1/qzs.qq.com/open/yyb/coupon/img/160x126.png
//        BitmapHelper.setImageViewBackground(this, imageView, url);
//        Bitmap bitmap = getLoacalBitmap("/sdcard/tubiao.jpg"); //从本地取图片(在cdcard中获取)  //
         bitmap = getLoacalBitmap(url); //从本地取图片(在cdcard中获取)  //
