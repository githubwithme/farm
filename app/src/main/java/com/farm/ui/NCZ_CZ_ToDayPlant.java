...
import com.farm.R;
import com.farm.adapter.NCZ_CZ_TodayPlantAdapter;
...
@EActivity(R.layout.ncz_cz_todayplant)
public class NCZ_CZ_ToDayPlant extends Activity
{
	TimeThread timethread;
	private NCZ_CZ_TodayPlantAdapter listAdapter;
	...
	private void getListData(final int actiontype, final int objtype, final PullToRefreshListView lv, final BaseAdapter adapter, final TextView more, final ProgressBar progressBar, final int PAGESIZE, int PAGEINDEX)
	{
		...
		params.addQueryStringParameter("action", "plantGetYZByParkID");
		...
		http.send(HttpRequest.HttpMethod.POST, AppConfig.testurl, params, new RequestCallBack<String>()
		{
			...
			public void onSuccess(ResponseInfo<String> responseInfo)
			{
				...
				{
					AppContext.makeToast(NCZ_CZ_ToDayPlant.this, "error_connectDataBase");
					return;
				}
				// 数据处理
				...
				case UIHelper.LISTVIEW_ACTION_CHANGE_CATALOG:// 页面切换
					...
					if (actiontype == UIHelper.LISTVIEW_ACTION_REFRESH)
					{
						...
						if (newdata > 0)
						{
							NewDataToast.makeText(NCZ_CZ_ToDayPlant.this, getString(R.string.new_data_toast_message, newdata), appContext.isAppSound(), R.raw.newdatatoast).show();
						} else
						{
							// NewDataToast.makeText(NCZ_CZ_ToDayPlant.this,
				...
				} else if (size == -1)
				{
					...
					AppContext.makeToast(NCZ_CZ_ToDayPlant.this, "load_error");
				}
			...
			{
				AppContext.makeToast(NCZ_CZ_ToDayPlant.this, "error_connectServer");
			}
		});
	}
	...
	{
		listAdapter = new NCZ_CZ_TodayPlantAdapter(NCZ_CZ_ToDayPlant.this, listData);
		list_footer = NCZ_CZ_ToDayPlant.this.getLayoutInflater().inflate(R.layout.listview_footer, null);
