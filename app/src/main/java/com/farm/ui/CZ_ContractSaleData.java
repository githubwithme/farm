...
public class CZ_ContractSaleData extends Activity implements CustomHorizontalScrollView_Allitem.CustomOntouch
{
    String areaid;
    @ViewById
...
//        getBatchTimeOfPark();
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getActionBar().hide();
        commembertab = AppContext.getUserInfo(CZ_ContractSaleData.this);
    ...
    {
        listData = FileHelper.getAssetsData(CZ_ContractSaleData.this, "getContractSaleData", BatchTime.class);
        if (listData != null)
        {
            DensityUtil densityUtil = new DensityUtil(CZ_ContractSaleData.this);
    ...
    public void getBatchTimeOfPark()
    {
        ...
        http.send(HttpRequest.HttpMethod.POST, AppConfig.testurl, params, new RequestCallBack<String>()
        {
            ...
            public void onSuccess(ResponseInfo<String> responseInfo)
            {
                ...
                {
                    AppContext.makeToast(CZ_ContractSaleData.this, "error_connectDataBase");
                    return;
                }
            ...
            {
                AppContext.makeToast(CZ_ContractSaleData.this, "error_connectServer");
            }
        });
    }
    ...
    private void initViews()
    {
        ...
        int allnumber = 0;
        LayoutInflater inflater = (LayoutInflater) CZ_ContractSaleData.this.getSystemService(LAYOUT_INFLATER_SERVICE);
...
//        CustomHorizontalScrollView_Allitem totalScroll = (CustomHorizontalScrollView_Allitem) findViewById(R.id.totalScroll);
    ...
    class ScrollAdapter extends BaseAdapter
    {
        ...
        {
            convertView = LayoutInflater.from(CZ_ContractSaleData.this).inflate(R.layout.cz_contractsale_scrolladapter_item, null);
            ...
            {
                View view = LayoutInflater.from(CZ_ContractSaleData.this).inflate(R.layout.cz_contractsale_dataitem, null);
