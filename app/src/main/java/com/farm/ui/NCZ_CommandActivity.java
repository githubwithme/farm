 ...
 */
@EActivity(R.layout.ncz_commandactivity)
public class NCZ_CommandActivity extends FragmentActivity
{
    ...
    void btn_addcommand()
    {
        Intent intent = new Intent(NCZ_CommandActivity.this, NCZ_AddNewCommand_.class);
    ...
    void btn_add()
    {
        Intent intent = new Intent(NCZ_CommandActivity.this, AddPlantObservation_.class);
    ...
    void afterOncreate()
    {
        dictionary = DictionaryHelper.getDictionaryFromAssess(NCZ_CommandActivity.this, "NCZ_CMD");
        ...
        setSpinner();
        commembertab = AppContext.getUserInfo(NCZ_CommandActivity.this);
        ...
        viewPagerAdapter_gcdDetail = new ViewPagerAdapter_GcdDetail(NCZ_CommandActivity.this.getSupportFragmentManager(), vPager, fragmentList);
    ...
    private void setSpinner()
    {
        ...
        countyAdapter = new CustomArrayAdapter(NCZ_CommandActivity.this, mAreaDatasMap);
        countySpinner.setAdapter(countyAdapter);
        countySpinner.setSelection(0, true);

        workerAdapter = new CustomArrayAdapter(NCZ_CommandActivity.this, mWorkerDatasMap);
        workerSpinner.setAdapter(workerAdapter);
        workerSpinner.setSelection(0, true);
        dateAdapter = new CustomArrayAdapter(NCZ_CommandActivity.this, mDateDatasMap);
