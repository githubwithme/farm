 ...
 */
public class Adapter_CreateOrder_SelectProduct extends BaseExpandableListAdapter
{
    ...
    public Adapter_CreateOrder_SelectProduct(Context context, List<areatab> listData, ExpandableListView mainlistview)
    {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent)
    {
        ...
        if (v == null)
        {
            ...
            convertView = inflater.inflate(R.layout.createorder_selectproduct_child, null);//ncz_pc_todayjobadater-ncz_pc_todayjobadater
...
//            listItemView.tv_batchtime.setText(batchTime.getBatchTime() + "  " + batchTime.getBatchColor() + "  " + "已售:" + numberofsaleout + "售中:" + numberofselein + "拟售:" + numberofsalefor + "待售:" + numberofnewsale);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent)
    {
        ...
        {
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = inflater.inflate(R.layout.createorder_selectproduct_parent, null);
        }
    ...
    public class GridViewAdapter_SellOrDetail_NCZ extends BaseAdapter
    {
        ...
        public View getView(final int position, View convertView, ViewGroup parent)
        {
            if (convertView == null)
            {
                convertView = View.inflate(context, R.layout.adapter_createorder_gridview, null);
