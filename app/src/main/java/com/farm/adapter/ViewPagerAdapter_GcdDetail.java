...
public class ViewPagerAdapter_GcdDetail extends PagerAdapter implements OnPageChangeListener
{
    ...
    public ViewPagerAdapter_GcdDetail(FragmentManager fragmentManager, ViewPager viewPager, List<Fragment> fragments)
    {
