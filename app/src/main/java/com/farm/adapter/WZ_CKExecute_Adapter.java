 ...
 */
public class WZ_CKExecute_Adapter extends BaseExpandableListAdapter
{
    ...
    public WZ_CKExecute_Adapter(Context context, List<WZ_CRk> listData, ExpandableListView mainlistview)
    {
