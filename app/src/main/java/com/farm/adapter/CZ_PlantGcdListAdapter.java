 ...
 *
 */
public class CZ_PlantGcdListAdapter extends BaseAdapter
{
     ...
     * @param context
     */
    public CZ_PlantGcdListAdapter(Context context, List<PlantGcd> data)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        {
            // 获取list_item布局文件的视图
            convertView = listContainer.inflate(R.layout.cz_plantgcdlistadapter, null);
