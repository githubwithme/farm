...
public class Adapter_Search extends BaseAdapter
{
    ...
    private List<SearchEntity> listItems;// 数据集合
    ...
    public Adapter_Search(Context context, List<SearchEntity> data)
    {
    ...
    {
        searchEntity = listItems.get(position);
        // 自定义视图
        ...
        if (lmap.get(position) == null)
        {
            ...
            listItemView.tv_title.setText(searchEntity.getTitle());
            listItemView.tv_date.setText(searchEntity.getDate());
