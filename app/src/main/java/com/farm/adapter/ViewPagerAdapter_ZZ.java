...
public class ViewPagerAdapter_ZZ extends PagerAdapter implements OnPageChangeListener
{
    ...
    public ViewPagerAdapter_ZZ(FragmentManager fragmentManager, ViewPager viewPager, List<Fragment> fragments)
    {
