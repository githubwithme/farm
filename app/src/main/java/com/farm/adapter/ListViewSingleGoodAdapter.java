...
public class ListViewSingleGoodAdapter extends BaseAdapter
{
	...
	public ListViewSingleGoodAdapter(Context context, List<planttab> data)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		{
			// 获取list_item布局文件的视图
			convertView = listContainer.inflate(R.layout.listitem_singlegood, null);
		...
		{
			listItemView.tv_state.setText("库存低");
		} else if (planttab.getplantType().equals("2"))
		{
			listItemView.tv_state.setText("库存过量");
		}
