...
public class NCZ_PQ_CommandListAdapter extends BaseAdapter
{
	...
	public NCZ_PQ_CommandListAdapter(Context context, List<commandtab> data)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		{
			// 获取list_item布局文件的视图
			convertView = listContainer.inflate(R.layout.ncz_pq_commandlistadapter, null);
