...
public class NCZ_YQPQAdapter extends BaseAdapter
{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		// Typeface typeface = AppContext.getTypeface(context,
		// "Roboto-Regular.ttf");
		// listItemView.tv_czname.setTypeface(typeface);
		// listItemView.tv_yqname.setTypeface(typeface);
		// listItemView.tv_plant.setTypeface(typeface);
		// listItemView.tv_sq.setTypeface(typeface);
		// listItemView.tv_cmd.setTypeface(typeface);
		// listItemView.tv_plantnumber.setTypeface(typeface);
		// listItemView.tv_worknumber.setTypeface(typeface);
		// listItemView.tv_cmdnumber.setTypeface(typeface);

		listItemView.tv_czname.setTypeface(FontManager.getTypefaceByFontName(context, "wsyh.ttf"));
		listItemView.tv_yqname.setTypeface(FontManager.getTypefaceByFontName(context, "wsyh.ttf"));
		listItemView.tv_yqname.setTypeface(FontManager.getTypefaceByFontName(context, "wsyh.ttf"));
		listItemView.tv_plant.setTypeface(FontManager.getTypefaceByFontName(context, "wsyh.ttf"));
		listItemView.tv_cmd.setTypeface(FontManager.getTypefaceByFontName(context, "wsyh.ttf"));
		listItemView.tv_job.setTypeface(FontManager.getTypefaceByFontName(context, "wsyh.ttf"));
		listItemView.tv_sq.setTypeface(FontManager.getTypefaceByFontName(context, "wsyh.ttf"));
		listItemView.tv_yqmq.setTypeface(FontManager.getTypefaceByFontName(context, "wsyh.ttf"));
		listItemView.tv_yqgz.setTypeface(FontManager.getTypefaceByFontName(context, "wsyh.ttf"));
		listItemView.tv_yqzl.setTypeface(FontManager.getTypefaceByFontName(context, "wsyh.ttf"));
		listItemView.tv_yqsq.setTypeface(FontManager.getTypefaceByFontName(context, "wsyh.ttf"));
		listItemView.tv_pqgz.setTypeface(FontManager.getTypefaceByFontName(context, "wsyh.ttf"));
		listItemView.tv_pqzl.setTypeface(FontManager.getTypefaceByFontName(context, "wsyh.ttf"));
		listItemView.tv_pqmq.setTypeface(FontManager.getTypefaceByFontName(context, "wsyh.ttf"));
