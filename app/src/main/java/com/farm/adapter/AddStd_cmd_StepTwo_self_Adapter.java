 ...
 * 适配肥料选择界面的左边导航栏
 */
public class AddStd_cmd_StepTwo_self_Adapter extends BaseExpandableListAdapter
{
    ...
    private AddStd_Cmd_StepTwo_Self_goodslistdapter adapter;
    ListView listview;

    public AddStd_cmd_StepTwo_self_Adapter(Context context, Dictionary_wheel dictionary_wheel, ExpandableListView mainlistview, ListView listview, TextView tv_head, FragmentCallBack fragmentCallBack)
    {
        ...
        adapter = new AddStd_Cmd_StepTwo_Self_goodslistdapter(context, currentiv_tip, list_goods);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent)
    {
        ...
        if (v == null)
        {
            ...
            convertView = inflater.inflate(R.layout.layout_children_goods_self, null);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent)
    {
        ...
        {
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = inflater.inflate(R.layout.layout_parent_goods_self, null);
        }
