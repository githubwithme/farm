...
public class Adapter_NCZCommandProgress extends BaseAdapter
{
    ...
    public Adapter_NCZCommandProgress(Context context, List<ContractCommandProgressBean> data)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        {
            // 获取list_item布局文件的视图
            convertView = listContainer.inflate(R.layout.adapter_nczcommandprogress, null);
