...
public class OrderList_Adapter extends BaseAdapter
{
    ...
    private List<SellOrder> listItems;// 数据集合
    ...
    public OrderList_Adapter(Context context, List<SellOrder> data)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        // 设置文字和图片
        listItemView.tv_name.setText("\""+listItems.get(position).getBuyers()+"\""+"的订单");
        return convertView;
    }
}