...
public class Adapter_PGAssess extends BaseExpandableListAdapter
{
    ...
    public Adapter_PGAssess(Activity context, List<ContractAssessBean> listData, ExpandableListView mainlistview)
    {
