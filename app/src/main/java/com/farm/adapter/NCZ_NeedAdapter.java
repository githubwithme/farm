...
import com.farm.ui.NCZ_ApproveSettlement_;
...
/*        if (sellOrder.getFreeDeposit().equals("0"))
        ...
        listItemView.tv_ask.setText(status);
...
//                    Intent intent = new Intent(context, NCZ_JSD_NeedList_.class);
                    Intent intent = new Intent(context, NCZ_ApproveSettlement_.class);
