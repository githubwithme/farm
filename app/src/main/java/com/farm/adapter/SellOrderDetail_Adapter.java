...
public class SellOrderDetail_Adapter extends BaseAdapter
{
    ...
    public SellOrderDetail_Adapter(Activity context, List<commandtab> data)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        {
            // 获取list_item布局文件的视图
            convertView = listContainer.inflate(R.layout.sellorderdetail_adapter, null);
