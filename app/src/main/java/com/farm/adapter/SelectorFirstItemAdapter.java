...
public class SelectorFirstItemAdapter extends BaseAdapter
{
	...
	public SelectorFirstItemAdapter(Context context, List<Map<String, Object>> list)
	{
		this.context = context;
		this.list = list;
	}

	public SelectorFirstItemAdapter(Context context, List<Map<String, Object>> list, boolean islodingimg)
	{
		this.context = context;
		this.list = list;
	...
	public View getView(int arg0, View view, ViewGroup viewGroup)
	{
		...
		if (view == null)
		{
			view = View.inflate(context, R.layout.selectorfirstitem, null);
