...
public class ListViewSingleGoodInvoicingAdapter extends BaseAdapter
{
	...
	public ListViewSingleGoodInvoicingAdapter(Context context, List<planttab> data)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		{
			// 获取list_item布局文件的视图
			convertView = listContainer.inflate(R.layout.listitem_singlegoodinvoicing, null);
		...
		{
			listItemView.tv_state.setText("进库");
		} else if (planttab.getplantType().equals("2"))
		{
			listItemView.tv_state.setText("出库");
		}
