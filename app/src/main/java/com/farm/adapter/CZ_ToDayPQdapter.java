...
public class CZ_ToDayPQdapter extends BaseAdapter
{
    String audiopath;
    ...
    public CZ_ToDayPQdapter(Context context, List<areatab> data)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        {
            // 获取list_item布局文件的视图
            convertView = listContainer.inflate(R.layout.cz_todaypqadapter, null);
            ...
            listItemView.ll_plant.setOnClickListener(new OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    Intent intent = new Intent(context, CZ_GddList_.class);
