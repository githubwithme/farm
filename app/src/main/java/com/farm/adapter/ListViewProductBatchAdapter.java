...
public class ListViewProductBatchAdapter extends BaseAdapter
{
	...
	public ListViewProductBatchAdapter(Context context, List<planttab> data)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		{
			// 获取list_item布局文件的视图
			convertView = listContainer.inflate(R.layout.listitem_productbatch, null);
		...
		{
			listItemView.tv_state.setText("销售中");
		} else if (planttab.getplantType().equals("2"))
		{
			listItemView.tv_state.setText("已售完");
		}
