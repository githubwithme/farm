...
public class NCZ_CZ_TodayJobAdapter extends BaseAdapter
{
    String audiopath;
    ...
    public NCZ_CZ_TodayJobAdapter(Context context, List<jobtab> data)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        {
            // 获取list_item布局文件的视图
            convertView = listContainer.inflate(R.layout.ncz_cz_todayjobadapter, null);
