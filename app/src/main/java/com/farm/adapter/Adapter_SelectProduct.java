 ...
 */
public class Adapter_SelectProduct extends BaseExpandableListAdapter
{
    ...
    public Adapter_SelectProduct(Context context, List<areatab> listData, ExpandableListView mainlistview)
    {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent)
    {
        ...
        if (v == null)
        {
            ...
            convertView = inflater.inflate(R.layout.adapter_selectproduct_child, null);//ncz_pc_todayjobadater-ncz_pc_todayjobadater
...
//            listItemView.tv_batchtime.setText(batchTime.getBatchTime() + "  " + batchTime.getBatchColor() + "  " + "已售:" + numberofsaleout + "售中:" + numberofselein + "拟售:" + numberofsalefor + "待售:" + numberofnewsale);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent)
    {
        if (convertView == null)
        {
            if (groupPosition == 0)
            {
                convertView = LayoutInflater.from(context).inflate(R.layout.adapter_selectproduct_topparent, null);
            } else
            {
                convertView = LayoutInflater.from(context).inflate(R.layout.adapter_selectproduct_parent, null);
            }
        ...
        {
            tv_number.setText(areatab.getAllsalefor());
        }
        return convertView;
    }
    ...
    public class GridViewAdapter_SellOrDetail_NCZ extends BaseAdapter
    {
        ...
        public View getView(final int position, View convertView, ViewGroup parent)
        {
            if (convertView == null)
            {
                convertView = View.inflate(context, R.layout.adapter_selectproduct_childitem, null);
                ...
                view.cb_selectall.setTag(R.id.tag_btn_number, view.btn_number);
                view.cb_selectall.setTag(R.id.tag_number, Integer.valueOf(list.get(position).getAllsalefor()));
                view.tv_areaname.setText(list.get(position).getContractNum());
                view.btn_number.setText(list.get(position).getAllsalefor());
                view.btn_number.setTag(R.id.tag_checkbox, view.cb_selectall);
...
//                        convertView.setBackgroundResource(R.color.gray);
                ...
                {
                    view.tv_number.setText(list.get(position).getAllsalefor());
            ...
            view.cb_selectall.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
            {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked)
                {
                    ...
                    int salefornumber = (int) buttonView.getTag(R.id.tag_number);
                    Button btn_number = (Button) buttonView.getTag(R.id.tag_btn_number);
                    if (isChecked)
                    {
