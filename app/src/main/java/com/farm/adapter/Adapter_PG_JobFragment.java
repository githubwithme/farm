...
public class Adapter_PG_JobFragment extends BaseAdapter
{
    String audiopath;
    ...
    public Adapter_PG_JobFragment(Context context, List<jobtab> data)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        {
            // 获取list_item布局文件的视图
            convertView = listContainer.inflate(R.layout.adapter_pg_jobfragment, null);
