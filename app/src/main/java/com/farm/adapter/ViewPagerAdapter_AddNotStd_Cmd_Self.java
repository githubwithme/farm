...
public class ViewPagerAdapter_AddNotStd_Cmd_Self extends PagerAdapter implements OnPageChangeListener
{
    ...
    public ViewPagerAdapter_AddNotStd_Cmd_Self(FragmentManager fragmentManager, ViewPager viewPager, List<Fragment> fragments)
    {
