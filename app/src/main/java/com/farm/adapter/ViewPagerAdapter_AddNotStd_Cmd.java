...
import com.farm.ui.AddNotStd_Cmd_StepSix;
import com.farm.ui.AddStd_Cmd_StepThree_Temp;

import java.util.ArrayList;
import java.util.List;

public class ViewPagerAdapter_AddNotStd_Cmd extends PagerAdapter implements OnPageChangeListener
{
    ...
    public ViewPagerAdapter_AddNotStd_Cmd(FragmentManager fragmentManager, ViewPager viewPager, List<Fragment> fragments)
    {
        ...
        if (fragment != null)
        {
            switch (item)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    ((AddNotStd_Cmd_StepSix) fragment).update();
                    break;
