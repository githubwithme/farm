 ...
 * 
 */
public class NCZ_CZ_TodayPlantAdapter extends BaseAdapter
{
	 ...
	 * @param context
	 */
	public NCZ_CZ_TodayPlantAdapter(Context context, List<planttab> data)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		{
			// 获取list_item布局文件的视图
			convertView = listContainer.inflate(R.layout.ncz_cz_todayplantadapter, null);
