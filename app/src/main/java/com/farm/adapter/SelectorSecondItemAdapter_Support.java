...
import com.farm.ui.SelectorFragment_Support;

import java.util.HashMap;
import java.util.List;

public class SelectorSecondItemAdapter_Support extends BaseAdapter
{

	private Context context;
	private int position = 0;
	private LayoutInflater listContainer;// 视图容器
	SelectorFragment_Support selectorFragment;
	String firstItemId;
	...
	public SelectorSecondItemAdapter_Support(SelectorFragment_Support selectorFragment, Context context, String BELONG, String firstItemId, String firstItemName, List<String> secondItemid, List<String> secondItemName, List<View> list_state)
	{
