...
import com.farm.ui.AddStd_Cmd_StepSix;
import com.farm.ui.AddStd_Cmd_StepThree_Temp;

import java.util.ArrayList;
import java.util.List;

public class PagerAdapter_AddPlantObservation extends PagerAdapter implements OnPageChangeListener
{
    ...
    public PagerAdapter_AddPlantObservation(FragmentManager fragmentManager, ViewPager viewPager, List<Fragment> fragments)
    {
