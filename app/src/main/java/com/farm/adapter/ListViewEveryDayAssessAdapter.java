...
public class ListViewEveryDayAssessAdapter extends BaseAdapter
{
	...
	public ListViewEveryDayAssessAdapter(Context context, List<plantgrowthtab> data)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		{
			// 获取list_item布局文件的视图
			convertView = listContainer.inflate(R.layout.listitem_everydayasssess, null);
