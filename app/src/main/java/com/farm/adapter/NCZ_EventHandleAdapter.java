 ...
 */
public class NCZ_EventHandleAdapter extends BaseAdapter {
    private Context context;// 运行上下文
    private List<HandleBean> listItems;// 数据集合
    private LayoutInflater listContainer;
    HandleBean HandleBean;

    public NCZ_EventHandleAdapter(Context context, List<HandleBean> data)
    {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        listItemView.name.setText(HandleBean.getSolveName());
