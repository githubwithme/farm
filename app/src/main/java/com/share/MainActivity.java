...
//
//public class MainActivity extends Activity implements OnMapScreenShotListener, OnMarkerClickListener, OnMapLoadedListener, InfoWindowAdapter, OnClickListener
//{
//
...
//	}
//
//	private void drawMyLocation(final String title, final double latitude, final double longitude)
//	{
//		if (isMapLoad)
//		{
//			aMap.clear();
...
//
//		AndroidShare as = new AndroidShare(MainActivity.this, "我在这里" + desc + "!快来和你的小伙伴们分享你的位置吧", savePath);
//		as.show();
//	}
//
//	// 对marker标注点点击响应事件
